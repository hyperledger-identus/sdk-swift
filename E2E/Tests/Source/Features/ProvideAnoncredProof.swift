...
final class ProvideAnoncredProof: Feature {
    override var tags: [String] { ["anoncred", "proof"] }
    override var title: String { "Provide anonymous proof" }
    override var narrative: String { "The Edge Agent should provide anonymous proof to Cloud Agent" }
    ...
    func testRespondÏToAPresentRequestWithWrongAttribute() async throws {
