...
final class ProvideJwtProof: Feature {
    override var tags: [String] { ["jwt", "proof"] }
    override var title: String { "Provide jwt proof" }
    override var narrative: String { "The Edge Agent should provide jwt proof to Cloud Agent" }
